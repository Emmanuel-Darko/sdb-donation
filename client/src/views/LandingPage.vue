...
<style lang="css" scoped>
    *{
    ...
    .banner-left .head-text{
        margin-top: -100px;
        font-size: 120px;
        color: orange;
    }
    .banner-left .head-sub{
        font-size: 80px;
        color: green;
        margin-top: -70px;
    }
    .banner-left .head-sub2{
        font-size: 80px;
        color: brown;
        margin-bottom: 40px;
    }
